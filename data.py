...
if __name__ == "__main__":
    ...
    create_dir("/content/drive/MyDrive/new_data/train/images/")
    create_dir("/content/drive/MyDrive/new_data/train/masks/")
    create_dir("/content/drive/MyDrive/new_data/valid/images/")
    create_dir("/content/drive/MyDrive/new_data/valid/masks/")
    create_dir("/content/drive/MyDrive/new_data/test/images/")
    create_dir("/content/drive/MyDrive/new_data/test/masks/")

    augment_data(train_x, train_y, "/content/drive/MyDrive/new_data/train/", augment=True)
    augment_data(valid_x, valid_y, "/content/drive/MyDrive/new_data/valid/", augment=False)
    augment_data(test_x, test_y, "/content/drive/MyDrive/new_data/test/", augment=False)
